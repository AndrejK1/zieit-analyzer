...
public abstract class SparkConnectionSource {
    ...
    protected SparkConf buildDefaultConfiguration() {
        return new SparkConf()
                ...
                .set("spark.sql.session.timeZone", "Europe/Helsinki")
                .set("spark.driver.extraJavaOptions", "-Duser.timezone=Europe/Helsinki")
                .set("spark.executor.extraJavaOptions", "-Duser.timezone=Europe/Helsinki")
